from eutilities.name.name_parser import derek73_nameparser, klauslippert_personnamenorm
...
if len(batch_insert_data) != 0:
    v = DBReader.tcp_client.execute(query="insert into and_ds.orcid_mag_s2_author_name_split_by_various_algorithms VALUES",
